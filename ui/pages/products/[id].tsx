...
export default function ProductAbout({
  ...
  const getRating = () => {
    ...
    const rating = reviews.reduce((p, v) => p + v.rating, 0) / reviews.length;
    console.log(rating);
    return rating;
  };
          ...
          <div className="flex flex-row basis-1/2 ">
            ...
            <div className="flex flex-col items-center basis-4/5 ml-2">
              ...
              <div className="flex flex-row mt-10">
                <p className="ml-2 mr-2 text-sm font-medium text-gray-500 dark:text-gray-400">
                  {Math.round(getRating() * 10) / 10} de 5
                </p>
                <Rating
                  emptySymbol={
                    <svg
