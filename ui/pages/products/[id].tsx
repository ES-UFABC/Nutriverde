                ...
                <li className="py-3 sm:py-4">
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex flex-row">
                        <p className="text-xs text-left basis-1/2">12/05/2005</p>
                        <div className=" flex basis-1/2 place-content-end">
                        <button className=" btn btn-primary btn-sm text-xs ml-3  "><PaperAirplaneIcon className="block w-4 h-4"/>SUBMETER</button>
                        </div>
                      </div>
                    </div>
