...
export default function MyProductCreate() {
  ...
  const { getRootProps, getInputProps } = useDropzone({
    ...
    onDropAccepted: async (files) => {
      ...
      setCover(uploadedFiles?.length ? uploadedFiles[0].id : undefined);
    ...
    <Layout title="Registro de Produtos">
      <Formik
        ...
        validationSchema={Yup.object({
          ...
          typology: Yup.string().required("Obrigatório"),
          quantity: Yup.number()
            .integer()
          ...
          cropDate: Yup.date()
            ...
            .required("Obrigatório"),
          price: Yup.number().positive().required("Obrigatório"),
        ...
        {({ setFieldValue }) => (
          <div className="container mx-auto p-4 flex flex-col justify-content-center">
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-y-12">
              {step === 0 ? (
                <>
                  <InputField label="Nome do produto" name="name" />
